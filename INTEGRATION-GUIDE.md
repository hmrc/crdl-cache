...
All the filtering parameters of crdl-cache are supported and the service behaves as similarly as possible to crdl-cache with some [minor differences](https://github.com/hmrc/crdl-cache-stub?tab=readme-ov-file#differences).
